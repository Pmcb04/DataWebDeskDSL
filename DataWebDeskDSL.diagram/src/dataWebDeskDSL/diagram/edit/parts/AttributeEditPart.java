...
public class AttributeEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new dataWebDeskDSL.diagram.edit.policies.AttributeItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof dataWebDeskDSL.diagram.edit.parts.AttributeNameEditPart) {
			((dataWebDeskDSL.diagram.edit.parts.AttributeNameEditPart) childEditPart)
	...
	*/
	...
	public class AttributeFigure extends SVGFigure {
		...
		public AttributeFigure() {
			this.setURI("platform:/plugin/DataWebDeskDSL/icons/atributo.svg");
