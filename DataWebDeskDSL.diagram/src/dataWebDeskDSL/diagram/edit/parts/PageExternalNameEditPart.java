 ...
 * @generated
 */
public class PageExternalNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PageExternalNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PageExternal_3013, getParserElement(),
