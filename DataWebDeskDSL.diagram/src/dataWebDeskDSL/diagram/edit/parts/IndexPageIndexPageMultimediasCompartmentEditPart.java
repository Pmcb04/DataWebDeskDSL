 ...
 * @generated
 */
public class IndexPageIndexPageMultimediasCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public IndexPageIndexPageMultimediasCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return dataWebDeskDSL.diagram.part.Messages.IndexPageIndexPageMultimediasCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new dataWebDeskDSL.diagram.edit.policies.IndexPageIndexPageMultimediasCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new dataWebDeskDSL.diagram.edit.policies.IndexPageIndexPageMultimediasCompartmentCanonicalEditPolicy());
	}
