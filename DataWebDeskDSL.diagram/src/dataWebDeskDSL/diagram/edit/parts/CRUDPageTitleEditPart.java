 ...
 * @generated
 */
public class CRUDPageTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CRUDPageTitleEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.CRUDPage_2017, getParserElement(),
