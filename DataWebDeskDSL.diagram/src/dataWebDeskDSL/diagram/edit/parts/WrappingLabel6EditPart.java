	...
	*/
	static {
		registerSnapBackPosition(dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getType(dataWebDeskDSL.diagram.edit.parts.WrappingLabel6EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.AttributeType_4007, getParserElement(),
