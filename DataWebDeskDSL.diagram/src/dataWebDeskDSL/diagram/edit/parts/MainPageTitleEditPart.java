 ...
 * @generated
 */
public class MainPageTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MainPageTitleEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.MainPage_2016, getParserElement(),
