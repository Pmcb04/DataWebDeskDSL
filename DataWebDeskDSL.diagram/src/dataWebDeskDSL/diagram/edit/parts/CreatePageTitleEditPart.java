 ...
 * @generated
 */
public class CreatePageTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CreatePageTitleEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dataWebDeskDSL.diagram.providers.DataWebDeskDSLParserProvider.getParser(
					dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.CreatePage_2011, getParserElement(),
