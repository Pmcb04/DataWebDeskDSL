 ...
 * @generated
 */
public class MainPageMainPageMultimediasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getMainPageMainPageMultimediasCompartment_7040SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getMainPageMainPageMultimediasCompartment_7040SemanticChildren((View) getHost().getModel());
