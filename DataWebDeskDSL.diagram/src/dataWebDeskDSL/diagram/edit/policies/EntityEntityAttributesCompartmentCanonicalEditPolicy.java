...
public class EntityEntityAttributesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return dataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getEntity_Attributes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getEntityEntityAttributesCompartment_7022SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return dataWebDeskDSL.diagram.edit.parts.AttributeEditPart.VISUAL_ID == dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getEntityEntityAttributesCompartment_7022SemanticChildren((View) getHost().getModel());
