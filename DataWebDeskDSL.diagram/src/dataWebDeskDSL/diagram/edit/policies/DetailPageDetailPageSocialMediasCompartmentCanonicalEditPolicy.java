 ...
 * @generated
 */
public class DetailPageDetailPageSocialMediasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getDetailPageDetailPageSocialMediasCompartment_7026SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getDetailPageDetailPageSocialMediasCompartment_7026SemanticChildren((View) getHost().getModel());
