 ...
 * @generated
 */
public class NormalPageNormalPageSocialMediasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getNormalPageNormalPageSocialMediasCompartment_7035SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getNormalPageNormalPageSocialMediasCompartment_7035SemanticChildren((View) getHost().getModel());
