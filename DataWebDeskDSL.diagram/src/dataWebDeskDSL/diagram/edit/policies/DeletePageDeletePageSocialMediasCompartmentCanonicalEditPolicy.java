 ...
 * @generated
 */
public class DeletePageDeletePageSocialMediasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return dataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getPage_SocialMedias();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getDeletePageDeletePageSocialMediasCompartment_7029SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return dataWebDeskDSL.diagram.edit.parts.SocialMediaEditPart.VISUAL_ID == dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getDeletePageDeletePageSocialMediasCompartment_7029SemanticChildren((View) getHost().getModel());
