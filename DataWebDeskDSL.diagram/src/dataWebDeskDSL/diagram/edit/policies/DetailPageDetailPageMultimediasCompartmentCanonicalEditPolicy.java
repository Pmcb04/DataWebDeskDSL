 ...
 * @generated
 */
public class DetailPageDetailPageMultimediasCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return dataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getPage_Multimedias();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getDetailPageDetailPageMultimediasCompartment_7028SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getDetailPageDetailPageMultimediasCompartment_7028SemanticChildren((View) getHost().getModel());
