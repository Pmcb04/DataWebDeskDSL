 ...
 * @generated
 */
public class NormalPageNormalPagePagesexternalCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return dataWebDeskDSL.DataWebDeskDSLPackage.eINSTANCE.getPage_Pagesexternal();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getNormalPageNormalPagePagesexternalCompartment_7036SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return dataWebDeskDSL.diagram.edit.parts.PageExternalEditPart.VISUAL_ID == dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getNormalPageNormalPagePagesexternalCompartment_7036SemanticChildren((View) getHost().getModel());
