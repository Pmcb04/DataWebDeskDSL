...
public class DeletePageItemSemanticEditPolicy
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
					.getVisualID(incomingLink) == dataWebDeskDSL.diagram.edit.parts.RolAccessEditPart.VISUAL_ID) {
			...
			if (dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.getVisualID(
					incomingLink) == dataWebDeskDSL.diagram.edit.parts.PagePagesReferencesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry
					.getVisualID(incomingLink) == dataWebDeskDSL.diagram.edit.parts.EntityCrudpagesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (dataWebDeskDSL.diagram.part.DataWebDeskDSLVisualIDRegistry.getVisualID(
					outgoingLink) == dataWebDeskDSL.diagram.edit.parts.PagePagesReferencesEditPart.VISUAL_ID) {
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.RolAccess_4006 == req.getElementType()) {
			return null;
		}
		if (dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PagePagesReferences_4001 == req
				.getElementType()) {
			return getGEFWrapper(new dataWebDeskDSL.diagram.edit.commands.PagePagesReferencesCreateCommand(req,
	...
	protected Command getCompleteCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.RolAccess_4006 == req.getElementType()) {
			return getGEFWrapper(new dataWebDeskDSL.diagram.edit.commands.RolAccessCreateCommand(req, req.getSource(),
					req.getTarget()));
		}
		if (dataWebDeskDSL.diagram.providers.DataWebDeskDSLElementTypes.PagePagesReferences_4001 == req
				.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case dataWebDeskDSL.diagram.edit.parts.RolAccessEditPart.VISUAL_ID:
			return getGEFWrapper(new dataWebDeskDSL.diagram.edit.commands.RolAccessReorientCommand(req));
		case dataWebDeskDSL.diagram.edit.parts.PagePagesReferencesEditPart.VISUAL_ID:
			return getGEFWrapper(new dataWebDeskDSL.diagram.edit.commands.PagePagesReferencesReorientCommand(req));
