 ...
 * @generated
 */
public class MainPageMainPagePagesexternalCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getMainPageMainPagePagesexternalCompartment_7039SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<dataWebDeskDSL.diagram.part.DataWebDeskDSLNodeDescriptor> childDescriptors = dataWebDeskDSL.diagram.part.DataWebDeskDSLDiagramUpdater
				.getMainPageMainPagePagesexternalCompartment_7039SemanticChildren((View) getHost().getModel());
