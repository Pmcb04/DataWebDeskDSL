...
/**
 * Entry point of the 'Generate_doc' generation module.
 *
 * @generated
 */
public class Generate_doc extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/DataWebDeskDSL/applicattiongen/main/generate_doc";
     ...
     * @generated
     */
    public Generate_doc(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Generate_doc(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Generate_doc generator = new Generate_doc(modelURI, folder, arguments);
