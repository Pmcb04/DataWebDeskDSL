...
/**
 * This is the item provider adapter for a {@link dataWebDeskDSL.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends MultimediaItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_extension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_extension_feature", "_UI_Image_type"),
				 DataWebDeskDSLPackage.Literals.IMAGE__EXTENSION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Image.class)) {
			case DataWebDeskDSLPackage.IMAGE__EXTENSION:
