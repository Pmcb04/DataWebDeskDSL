...
/**
 * This is the item provider adapter for a {@link dataWebDeskDSL.Multimedia} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultimediaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Multimedia_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Multimedia_name_feature", "_UI_Multimedia_type"),
				 DataWebDeskDSLPackage.Literals.MULTIMEDIA__NAME,
				 true,
				 false,
				 false,
