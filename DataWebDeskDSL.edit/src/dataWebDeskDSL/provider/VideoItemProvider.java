...
/**
 * This is the item provider adapter for a {@link dataWebDeskDSL.Video} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VideoItemProvider extends MultimediaItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Video_extension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Video_extension_feature", "_UI_Video_type"),
				 DataWebDeskDSLPackage.Literals.VIDEO__EXTENSION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Video.class)) {
			case DataWebDeskDSLPackage.VIDEO__EXTENSION:
