...
/**
 * This is the item provider adapter for a {@link dataWebDeskDSL.Text} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextItemProvider extends MultimediaItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_extension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_extension_feature", "_UI_Text_type"),
				 DataWebDeskDSLPackage.Literals.TEXT__EXTENSION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Text.class)) {
			case DataWebDeskDSLPackage.TEXT__EXTENSION:
